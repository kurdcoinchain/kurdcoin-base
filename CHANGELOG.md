...
## [v4.0.0](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.4..v4.0.0)

## Add
- Add the `Claimant` class which helps the creation of claimable balances. ([#367](https://github.com/stellar/js-kurdcoin-base/pull/367)).
...
```
KurdCoinBase.Claimant.predicateUnconditional();
KurdCoinBase.Claimant.predicateAnd(left, right);
KurdCoinBase.Claimant.predicateOr(left, right);
KurdCoinBase.Claimant.predicateNot(predicate);
KurdCoinBase.Claimant.predicateBeforeAbsoluteTime(unixEpoch);
KurdCoinBase.Claimant.predicateBeforeRelativeTime(seconds);
```
...
const right = KurdCoinBase.Claimant.predicateBeforeRelativeTime(
  '1200'
);
...
- Add `Operation.createClaimableBalance` ([#368](https://github.com/stellar/js-kurdcoin-base/pull/368))
...
- Add `Operation.claimClaimableBalance` ([#368](https://github.com/stellar/js-kurdcoin-base/pull/368))
...
```
- Add support for Sponsored Reserves (CAP33)([#369](https://github.com/stellar/js-kurdcoin-base/pull/369/))
...
## [v3.0.4](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.3..v3.0.4)

### Update

- Generate V1 transactions by default and allow V0 transactions to be fee bumped ([#355](https://github.com/stellar/js-kurdcoin-base/pull/355)).

## [v3.0.3](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.2..v3.0.3)

### Remove

- Rollback support for SEP23 (Muxed Account StrKey) ([#349](https://github.com/stellar/js-kurdcoin-base/pull/349)).

## [v3.0.2](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.1..v3.0.2)

### Fix
- Extend `files` in npm package to include XDR type definitions ([#345](https://github.com/stellar/js-kurdcoin-base/pull/345)).

## [v3.0.1](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.0..v3.0.1)

### Add
- Add TypeScript definitions for auto-generated XDR code ([#342](https://github.com/stellar/js-kurdcoin-base/pull/342)).

## [v3.0.0](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.9..v3.0.0)

This version brings protocol 13 support with backwards compatibility support for protocol 12.

### Add
- Add `TransactionBuilder.buildFeeBumpTransaction` which makes it easy to create `FeeBumpTransaction` ([#321](https://github.com/stellar/js-kurdcoin-base/pull/321)).
- Adds a feature flag which allow consumers of this library to create V1 (protocol 13) transactions using the `TransactionBuilder` ([#321](https://github.com/stellar/js-kurdcoin-base/pull/321)).
- Add support for [CAP0027](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0027.md): First-class multiplexed accounts ([#325](https://github.com/stellar/js-kurdcoin-base/pull/325)).
- ~Add `Keypair.xdrMuxedAccount` which creates a new `xdr.MuxedAccount`([#325](https://github.com/stellar/js-kurdcoin-base/pull/325)).~
- Add `FeeBumpTransaction` which makes it easy to work with fee bump transactions ([#328](https://github.com/stellar/js-kurdcoin-base/pull/328)).
- Add `TransactionBuilder.fromXDR` which receives an xdr envelope and return a `Transaction` or `FeeBumpTransaction` ([#328](https://github.com/stellar/js-kurdcoin-base/pull/328)).

### Update
- Update XDR definitions with protocol 13 ([#317](https://github.com/stellar/js-kurdcoin-base/pull/317)).
- Extend `Transaction` to work with `TransactionV1Envelope` and `TransactionV0Envelope` ([#317](https://github.com/stellar/js-kurdcoin-base/pull/317)).
- Add backward compatibility support for [CAP0018](https://github.com/stellar/stellar-protocol/blob/f01c9354aaab1e8ca97a25cf888829749cadf36a/core/cap-0018.md) ([#317](https://github.com/stellar/js-kurdcoin-base/pull/317)).
...
- ~Update operations builder to support multiplexed accounts ([#337](https://github.com/stellar/js-kurdcoin-base/pull/337)).~

### Breaking changes

- `Transaction.toEnvelope()` returns a protocol 13 `xdr.TransactionEnvelope` which is an `xdr.Union` ([#317](https://github.com/stellar/js-kurdcoin-base/pull/317)).
...
- The return value from `Transaction.fee` changed from `number` to `string`. This brings support for `Int64` values ([#321](https://github.com/stellar/js-kurdcoin-base/pull/321)).
- The const `BASE_FEE` changed from `number` to `string` ([#321](https://github.com/stellar/js-kurdcoin-base/pull/321)).
- The option `fee` passed to  `new TransactionBuilder({fee: ..})` changed from `number` to `string` ([#321](https://github.com/stellar/js-kurdcoin-base/pull/321)).
- The following fields, which were previously an `xdr.AccountID` are now a  `xdr.MuxedAccount` ([#325](https://github.com/stellar/js-kurdcoin-base/pull/325)):
...
- Remove the following deprecated functions ([#331](https://github.com/stellar/js-kurdcoin-base/pull/331)):
  - `Operation.manageOffer`
  - `Operation.createPassiveOffer`
  - `Operation.pathPayment`
  - `Keypair.fromBase58Seed`
- Remove the `Network` class ([#331](https://github.com/stellar/js-kurdcoin-base/pull/331)).
- Remove `vendor/base58.js` ([#331](https://github.com/stellar/js-kurdcoin-base/pull/331)).

## [v3.0.0-alpha.1](https://github.com/stellar/js-kurdcoin-base/compare/v3.0.0-alpha.0..v3.0.0-alpha.1)
...
## [v3.0.0-alpha.0](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.9..v3.0.0-alpha.0)
...
## [v2.1.9](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.8..v2.1.9)

### Fix
- Update dependencies which depend on minimist. ([#332](https://github.com/stellar/js-kurdcoin-base/pull/332))

## [v2.1.8](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.7..v2.1.8)

### Fix
- Fix `setTimeout(0)` and partially defined timebounds ([#315](https://github.com/stellar/js-kurdcoin-base/pull/315)).

## [v2.1.7](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.6..v2.1.7)

### Fix
- Fix TypeScript options for `ManageData` operation to allow setting value to `null` ([#310](https://github.com/stellar/js-kurdcoin-base/issues/310))
- Fix crash on partially defined time bounds ([#303](https://github.com/stellar/js-kurdcoin-base/issues/303))

## [v2.1.6](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.5..v2.1.6)

### Fix
- Fix npm deployment.

## [v2.1.5](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.4..v2.1.5)

### Add
- Add `toXDR` type to Transaction class ([#296](https://github.com/stellar/js-kurdcoin-base/issues/296))

### Fix
- Fix doc link ([#298](https://github.com/stellar/js-kurdcoin-base/issues/298))

### Remove
- Remove node engine restriction ([#294](https://github.com/stellar/js-kurdcoin-base/issues/294))

### Update
- Update creating an account example ([#299](https://github.com/stellar/js-kurdcoin-base/issues/299))
- Use `console.trace` to get line num in `Networks.use` ([#300](https://github.com/stellar/js-kurdcoin-base/issues/300))

## [v2.1.4](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.3..v2.1.4)

## Update
- Regenerate the XDR definitions to include MetaV2 ([#288](https://github.com/stellar/js-kurdcoin-base/issues/288))

## [v2.1.3](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.2...v2.1.3)

## Update 📣

- Throw errors when obviously invalid network passphrases are used in
  `new Transaction()`.
  ([284](https://github.com/stellar/js-kurdcoin-base/pull/284))

## [v2.1.2](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.1...v2.1.2)

## Update 📣

- Update documentation for `Operation` to show `pathPaymentStrictSend` and `pathPaymentStrictReceive`. ([279](https://github.com/stellar/js-kurdcoin-base/pull/279))

## [v2.1.1](https://github.com/stellar/js-kurdcoin-base/compare/v2.1.0...v2.1.1)

## Update 📣

- Update `asset.toString()` to return canonical representation for asset. ([277](https://github.com/stellar/js-kurdcoin-base/pull/277)).
...
## [v2.1.0](https://github.com/stellar/js-kurdcoin-base/compare/v2.0.2...v2.1.0)
...
### Add ➕
 ...
 - `Operation.pathPaymentStrictSend`: Sends a path payments, debiting from the source account exactly a specified amount of one asset, crediting at least a given amount of another asset. ([#274](https://github.com/stellar/js-kurdcoin-base/pull/274)).
    ...
    ```
 - `Operation.pathPaymentStrictReceive`: This behaves the same as the former `pathPayments` operation. ([#274](https://github.com/stellar/js-kurdcoin-base/pull/274)).
...
- `Operation.pathPayment` is being deprecated in favor of `Operation.pathPaymentStrictReceive`. Both functions take the same arguments and behave the same. ([#274](https://github.com/stellar/js-kurdcoin-base/pull/274)).

## [v2.0.2](https://github.com/stellar/js-kurdcoin-base/compare/v2.0.1...v2.0.2)

### Fix
- Fix issue [#269](https://github.com/stellar/js-kurdcoin-base/issues/269). ManageBuyOffer should extend BaseOptions and inherited property "source". ([#270](https://github.com/stellar/js-kurdcoin-base/pull/270)).

## [v2.0.1](https://github.com/stellar/js-kurdcoin-base/compare/v2.0.0...v2.0.1)

No changes. Fixes deploy script and includes changes from [v2.0.0](https://github.com/stellar/js-kurdcoin-base/compare/v1.1.2...v2.0.0).

## [v2.0.0](https://github.com/stellar/js-kurdcoin-base/compare/v1.1.2...v2.0.0)

### BREAKING CHANGES

- Drop Support for Node 6 since it has been end-of-lifed and no longer in LTS. We now require Node 10 which is the current LTS until April 1st, 2021. ([#255](https://github.com/stellar/js-kurdcoin-base/pull/255))

## [v1.1.2](https://github.com/stellar/js-kurdcoin-base/compare/v1.1.1...v1.1.2)

### Fix
- Fix no-network warnings ([#248](https://github.com/stellar/js-kurdcoin-base/issues/248))

## [v1.1.1](https://github.com/stellar/js-kurdcoin-base/compare/v1.1.0...v1.1.1)

### Fix
- Add types for new networkPassphrase argument. Fix [#237](https://github.com/stellar/js-kurdcoin-base/issues/237). ([#238](https://github.com/stellar/js-kurdcoin-base/issues/238))

## [v1.1.0](https://github.com/stellar/js-kurdcoin-base/compare/v1.0.3...v1.1.0)
...
```js
const transaction = new KurdCoinSdk.TransactionBuilder(account, {
  fee: KurdCoinSdk.BASE_FEE,
  networkPassphrase: Networks.TESTNET
})
```

See [#207](https://github.com/stellar/js-kurdcoin-base/issues/207) and [#112](https://github.com/stellar/js-kurdcoin-base/issues/112) for more information.

The `Network` class will be removed on the `2.0` release.

### Add
- Add docs for BASE_FEE const. ([#211](https://github.com/stellar/js-kurdcoin-base/issues/211))

### Fix
- Fix typo. ([#213](https://github.com/stellar/js-kurdcoin-base/issues/213))

## [v1.0.3](https://github.com/stellar/js-kurdcoin-base/compare/v1.0.2...v1.0.3)

### Add

- Add `toString()` to Asset ([#172](https://github.com/stellar/js-kurdcoin-base/issues/172))
- Add types for missing Network functions ([#208](https://github.com/stellar/js-kurdcoin-base/issues/208))
- Add BASE_FEE to TS types ([#209](https://github.com/stellar/js-kurdcoin-base/issues/209))

### Fix
- Fix typo in types ([#194](https://github.com/stellar/js-kurdcoin-base/issues/194))
- Fix types: Fee is no longer optional ([#195](https://github.com/stellar/js-kurdcoin-base/issues/195))
- Fix typings for Account Sequence Number ([#203](https://github.com/stellar/js-kurdcoin-base/issues/203))
- Fix typings for Transaction Sequence Number ([#205](https://github.com/stellar/js-kurdcoin-base/issues/205))

## [v1.0.2](https://github.com/stellar/js-kurdcoin-base/compare/v1.0.1...v1.0.2)

- Fix a bug where `sodium-native` was making it into the browser bundle, which
  is supposed to use `tweetnacl`.

## [v1.0.1](https://github.com/stellar/js-kurdcoin-base/compare/v1.0.0...v1.0.1)
...
## [v1.0.0](https://github.com/stellar/js-kurdcoin-base/compare/v0.13.2...v1.0.0)
...
## [v0.13.2](https://github.com/stellar/js-kurdcoin-base/compare/v0.13.1...v0.13.2)
...
## [v0.13.1](https://github.com/stellar/js-kurdcoin-base/compare/v0.13.0...v0.13.1)

- Travis: Deploy NPM with an environment variable instead of an encrypted API
  key.
- Instruct Travis to cache node_modules

## [v0.13.0](https://github.com/stellar/js-kurdcoin-base/compare/v0.12.0...v0.13.0)
...
## [v0.12.0](https://github.com/stellar/js-kurdcoin-base/compare/v0.11.0...v0.12.0)
...
- **Breaking change** Added
  [`TransactionBuilder.setTimeout`](https://stellar.github.io/js-kurdcoin-base/TransactionBuilder.html#setTimeout)
