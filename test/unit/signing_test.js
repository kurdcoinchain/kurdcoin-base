...
describe('KurdCoinBase#sign', function() {
  ...
  it("can sign an string properly", function() {
    ...
    let actualSig   = KurdCoinBase.sign(data, secretKey).toString('hex');
...
describe('KurdCoinBase#verify', function() {
  ...
  it("can verify an string properly", function() {
    let data = "hello world";
    expect(KurdCoinBase.verify(data, sig, publicKey)).to.be.truthy;
    expect(KurdCoinBase.verify("corrupted", sig, publicKey)).to.be.falsey;
    expect(KurdCoinBase.verify(data, badSig, publicKey)).to.be.falsey;
  });
