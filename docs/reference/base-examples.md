...
```javascript
const server = new KurdCoinSdk.Server('https://horizon-testnet.stellar.org')
const source = KurdCoinSdk.Keypair.fromSecret('SA3W53XXG64ITFFIYQSBIJDG26LMXYRIMEVMNQMFAQJOYCZACCYBA34L')
const destination = KurdCoinSdk.Keypair.random()

server.accounts()
  .accountId(source.publicKey())
  .call()
  .then(({ sequence }) => {
    const account = new KurdCoinSdk.Account(source.publicKey(), sequence)
    const transaction = new KurdCoinSdk.TransactionBuilder(account, {
      fee: KurdCoinSdk.BASE_FEE,
      networkPassphrase: Networks.TESTNET
    })
      .addOperation(KurdCoinSdk.Operation.createAccount({
        destination: destination.publicKey(),
        startingBalance: '25'
      }))
      .setTimeout(30)
      .build()
    transaction.sign(KurdCoinSdk.Keypair.fromSecret(source.secret()))
...
```js
var nativeAsset = KurdCoinSdk.Asset.native();
...
var testAsset = new KurdCoinSdk.Asset('TEST', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB');
...
var googleStockAsset = new KurdCoinSdk.Asset('US38259P7069', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB');
```
...
```js
var keypair = KurdCoinSdk.Keypair.fromSecret(secretString);

var source = new KurdCoinSdk.Account(keypair.publicKey(), "46316927324160");
var transaction = new KurdCoinSdk.TransactionBuilder(source, {
    fee: KurdCoinSdk.BASE_FEE,
    networkPassphrase: Networks.TESTNET
  })
  .addOperation(KurdCoinSdk.Operation.pathPayment({
      sendAsset: KurdCoinSdk.Asset.native(),
      sendMax: "1000",
      destination: 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB',
      destAsset: new KurdCoinSdk.Asset('GBP', 'GASOCNHNNLYFNMDJYQ3XFMI7BYHIOCFW3GJEOWRPEGK2TDPGTG2E5EDW'),
      destAmount: "5.50",
      path: [
        new KurdCoinSdk.Asset('USD', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB'),
        new KurdCoinSdk.Asset('EUR', 'GDTNXRLOJD2YEBPKK7KCMR7J33AAG5VZXHAJTHIG736D6LVEFLLLKPDL')
      ]
  }))
  .setTimeout(30)
  .build();
...
```js
var rootKeypair = KurdCoinSdk.Keypair.fromSecret("SBQWY3DNPFWGSZTFNV4WQZLBOJ2GQYLTMJSWK3TTMVQXEY3INFXGO52X")
var account = new KurdCoinSdk.Account(rootkeypair.publicKey(), "46316927324160");

var secondaryAddress = "GC6HHHS7SH7KNUAOBKVGT2QZIQLRB5UA7QAGLA3IROWPH4TN65UKNJPK";

var transaction = new KurdCoinSdk.TransactionBuilder(account, {
    fee: KurdCoinSdk.BASE_FEE,
    networkPassphrase: Networks.TESTNET
  })
  .addOperation(KurdCoinSdk.Operation.setOptions({
    signer: {
...
var transaction = new KurdCoinSdk.TransactionBuilder(account, {
    ...
    .addOperation(KurdCoinSdk.Operation.payment({
...
var secondKeypair = KurdCoinSdk.Keypair.fromSecret("SAMZUAAPLRUH62HH3XE7NVD6ZSMTWPWGM6DS4X47HLVRHEBKP4U2H5E7");
