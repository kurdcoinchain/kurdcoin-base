...
The transaction will use the current sequence number of the given [Account](https://github.com/stellar/js-kurdcoin-base/blob/master/src/account.js) object as its sequence number and increments
...
See [operation.js](https://github.com/stellar/js-kurdcoin-base/blob/master/src/operation.js) for a list of possible operations you can add.
...
This will return a fully constructed [Transaction](https://github.com/stellar/js-kurdcoin-base/blob/master/src/transaction.js).
...
```js
// KurdCoinBase.Network.usePublicNetwork(); if this transaction is for the public network
// Create an Account object from an address and sequence number.
var account=new KurdCoinBase.Account("GD6WU64OEP5C4LRBH6NK3MHYIA2ADN6K6II6EXPNVUR3ERBXT4AN4ACD","2319149195853854");

var transaction = new KurdCoinBase.TransactionBuilder(account, {
        fee: KurdCoinBase.BASE_FEE,
        networkPassphrase: Networks.TESTNET
    })
        // add a payment operation to the transaction
        .addOperation(KurdCoinBase.Operation.payment({
...
by passing a [memo](https://github.com/stellar/js-kurdcoin-base/blob/master/src/memo.js) object when you construct the TransactionBuilder.
